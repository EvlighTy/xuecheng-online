...
public class EmailCodeService extends AbstractCheckCodeService implements CheckCodeService {
    @Override
    ...
    public CheckCodeResultVO generateVO(CheckCodeParamsDTO checkCodeParamsDTO) {
        GenerateResult generateResult = generateCode(checkCodeParamsDTO, null, "emailCode", 300);
